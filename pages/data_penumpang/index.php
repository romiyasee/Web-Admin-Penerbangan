...
<head>
  ...
  <title>Pemweb Airlines | Penumpang</title>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo baseurl("aksi.php") ?>">
                        <input type="hidden" class="form-control" id="id" aria-describedby="emailHelp" value="<?php echo $row["id_penumpang"]; ?>" name="id_penumpang">
                        <div class="mb-3">
                            <label for="no_pemesanan" class=" form-label">No Pemesanan</label>
                            <input type="text" class="form-control" id="no_pemesanan" aria-describedby="emailHelp" name="no_pemesanan">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="kode_rute" class=" form-label">Rute</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="no_kursi" aria-describedby="emailHelp" name="no_kursi">
                        </div>
                        <div class="mb-3">
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <!-- Button trigger modal -->
                                <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?php echo $row["id_penumpang"]; ?>">
                                <i class="fas fa-pen"></i>
                               </a>

                                <!-- Modal -->
                                <div class="modal fade" id="edit<?php echo $row["id_penumpang"]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Data Penumpang</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form method="post" action="<?php echo baseurl("aksi.php") ?>">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="no_pemesanan" class=" form-label">No Pemesanan</label>
                                                        <input type="text" class="form-control" id="no_pemesanan" aria-describedby="emailHelp" value="<?php echo $row["no_pemesanan"]; ?>" name="no_pemesanan">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="nama" class=" form-label">Nama</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="no_kursi" class=" form-label">No Kursi</label>
                                                        <input type="text" class="form-control" id="no_kursi" aria-describedby="emailHelp" value="<?php echo $row["no_kursi"]; ?>" name="no_kursi">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="kode_pesawat" class=" form-label">Kode Pesawat</label>
                                ...
                                <a type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $row["id_penumpang"]; ?>">
                                <i class="fas fa-trash"></i>
                                </a>
                                <div class="modal fade" id="hapus<?php echo $row["id_penumpang"]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Data Penumpang</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form method="post" action="<?php echo baseurl("aksi.php") ?>">
                                                    <input type="text" class="form-control" id="id" aria-describedby="emailHelp" value="<?php echo $row["id_penumpang"]; ?>" name="id_penumpang">
